...
**Mental Health eDischarge (inpatient discharge summary) Document** – An ITK FHIR Document containing Transfer of Care information supporting an inpatient discharge typically between an acute hospital and GP practice.
...
# ITK FHIR Mental Health eDischarge Focus #
...
The [ITK Mental Health eDischarge journey](overview_message_journey.html) outlines the development roadmap for FHIR Messaging using the ITK Mental Health eDischarge outlined messaging within this site. Note: This roadmap would include components from other NHS Digital specifications for example ITK Mental Health eDischarge message components, CareConnect profiles etc.
