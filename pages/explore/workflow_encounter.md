...
The Mental Health eDischarge does not support any real "work flow" but uses the encounter Resource to give context to the information contained in the eDischarge document. The encounter Resource represent the inpatient stay and can contain important information such as:
